...
class PaperProtocolTests(unittest.TestCase):
    def test_source_provenance_from_launcher_environment(self):
        values = {
            ...
            "EXPERIMENT_REPOSITORY_DIRTY": "true",
            "EXPERIMENT_PC_SUBMODULE_COMMIT": "pc-commit",
            "EXPERIMENT_PC_SUBMODULE_DIRTY": "false",
        }
        with patch.dict(common.os.environ, values, clear=False):
            self.assertEqual(common.source_provenance(), {
